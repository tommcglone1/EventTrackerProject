...
INSERT INTO `card` (`id`, `player_name`, `number`, `team`, `box_set`, `type`, `img_url`, `year`, `autographed`, `rookie`, `manufacturer`, `sale_value`, `trade_value`, `active`, `created`, `updated`, `sp_number`, `parallel`, `card_condition_id`, `grade_id`) VALUES (6, 'Ricardo Cabrera', 'B22-RCA', 'Reds', 'Bowman\'s Best', 'Base Prospect', 'https://i.ebayimg.com/images/g/3PQAAOSwie1kYp2n/s-l1600.jpg', 2022, 1, 0, 'Topps', 25, 50, '1', NULL, NULL, '33/50', 'Gold Background', 1, NULL);
INSERT INTO `card` (`id`, `player_name`, `number`, `team`, `box_set`, `type`, `img_url`, `year`, `autographed`, `rookie`, `manufacturer`, `sale_value`, `trade_value`, `active`, `created`, `updated`, `sp_number`, `parallel`, `card_condition_id`, `grade_id`) VALUES (7, 'Terrin Vavra', 'T88C-10', 'Orioles', 'Series 1', '35th Anniversary', 'https://i.ebayimg.com/images/g/EF0AAOSwp5xkB-zG/s-l1600.png', 2023, 0, 1, 'Topps', 10, 20, '1', NULL, NULL, NULL, 'Chrome', 1, 10);
