package com.skilldistillery.baseballcards.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain createFilterChain(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET, "/api/allCards").permitAll()    //allCards requests are allowed without authentication 
